...
export { default as BlogContact } from '../../components/BlogContact.vue'
...
export const LazyBlogContact = import('../../components/BlogContact.vue' /* webpackChunkName: "components/BlogContact" */).then(c => c.default || c)
